...
public class AdminHouseController {
	...
	@PostMapping("/create")
	public String create(@ModelAttribute @Validated 
			HouseRegisterForm houseRegisterForm, BindingResult bindingResult, 
	...
	public String edit(@PathVariable(name = "id")Integer id, Model model) {
		...
		HouseEditForm houseEditForm=new 
				HouseEditForm(house.getId(), house.getName(), null, 
	...
	public String delete(@PathVariable(name = "id")Integer id, 
		...
		redirectAttributes.addAttribute("successMessage", "民宿を削除しました。");
		return "redirect:/admin/houses";
	}
